...
namespace GamingCatalogue.Migrations
{
    ...
    [Migration("20260413082908_AddGenres")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamingCatalogue.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GamingCatalogue.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameGenre", b =>
                {
                    b.HasOne("GamingCatalogue.Models.Game", null)
                        .WithMany()
                        .HasForeignKey("GamesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamingCatalogue.Models.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GameTag", b =>
                {
                    ...
                    b.HasOne("GamingCatalogue.Models.Tag", null)
                        .WithMany()
